...
INTENT_CONFIG = {
    ...
    "campus_info": {
        ...
        "sources": [("campus_info.csv", 1.0), ("facilities.csv", 0.9), ("rooms_facilities.csv", 0.5), ("general_faq.csv", 0.3)]
    },
    "facilities": {
        "keywords": ["medical", "first aid", "reading room", "girls room", "placement cell", "training", "transport office", "main gate", "parking area", "auditorium", "seminar hall", "amphitheatre", "gymnasium", "sports complex"],
        "sources": [("facilities.csv", 1.0), ("campus_info.csv", 0.9), ("rooms_facilities.csv", 0.5), ("general_faq.csv", 0.3)]
    },
    "admissions": {
